...
function App() {
  ...
  return (
    ...
    <div className="bg-white flex justify-center gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
      ...
      <button onClick={increaseHandler} className="border-l-2 text-center w-20 border-[#bfbfbf] text-4xl font-bold">
        +
      </button>
    </div>
    <button onClick={resetHandler} className="bg-[#0298d4] px-5 py-2 rounded-sm text-lg">
      Reset
    </button>
    </div>
  );
